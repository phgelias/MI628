...
(1) The following statements are equivalent: $Z \perp Y$, $RD = 0$, $RR = 1$ and $OR = 1$.
...
The correlation coefficient between Y and Z is ρY Z. There are many equivalent
definitions of the partial correlation coefficient. For a multivariate Normal
vector, let ρY Z|X denote the partial correlation coefficient between Y and Z
